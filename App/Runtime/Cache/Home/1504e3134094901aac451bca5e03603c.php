	                ...
	                <div class="col-sm-12">
	                    ...
	                    <div class="collapse navbar-collapse" id="main-menu">
	                        <ul class="menu">
						    	...
						    	<li class="nav-current"><a href="<?php echo U('Article/suibi');?>">随笔文</a></li>
	    ...
	    <div class="container articleList">
	    	<div class="row">
	    		...
	    		<!--单个文章-->
	    			...
	    			<div class="article">
	    				<div class="articleHeader">
	    					<h1 class="articleTitle"><a href="<?php echo U('Article/suibi_detail', array('id'=>$vo['id'],'cate_id' => $vo['cate_id']));?>"><?php echo ($vo["title"]); ?></a></h1>
	    				</div>
	    				<div class="articleBody clearfix">
						<!--缩略图-->
						<div class="articleThumb">
					...
					<div class="articleFooter clearfix">
						...
						<a href="<?php echo U('Article/suibi_detail', array('id'=>$vo['id'],'cate_id' => $vo['cate_id']));?>" class="btn btn-readmore btn-info btn-md">阅读更多</a>
					</div>				
