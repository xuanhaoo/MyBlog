	                ...
	                <div class="col-sm-12">
	                    ...
	                    <div class="collapse navbar-collapse" id="main-menu">
	                        <ul class="menu">
						    	...
						    	<li><a href="<?php echo U('Article/suibi');?>">随笔文</a></li>
								...
								<li class="nav-current"><a href="<?php echo U('Article/game');?>">电子竞技</a></li>
	    ...
	    <div class="container articleList">
	    	<div class="row">
	    		...
	    		<!--单个文章-->
	    			...
	    			<div class="article">
	    				<div class="articleHeader">
	    					<h1 class="articleTitle"><a href="<?php echo U('Article/game_detail', array('id'=>$vo['id'],'cate_id' => $vo['cate_id']));?>"><?php echo ($vo["title"]); ?></a></h1>
	    				</div>
	    				<div class="articleBody clearfix">
						<!--缩略图-->
						<div class="articleThumb">
						...
						<!--摘要-->
						<div class="articleFeed">
						    <p><?php echo (msubstr(strip_tags(htmlspecialchars_decode($vo["content"])),0,140,'utf-8',true)); ?></p>
						</div>
						<!--tags-->
						<div class="articleTags">
							<ul>
					...
					<div class="articleFooter clearfix">
						...
						<a href="<?php echo U('Article/game_detail', array('id'=>$vo['id'],'cate_id' => $vo['cate_id']));?>" class="btn btn-readmore btn-info btn-md">阅读更多</a>
					</div>				
