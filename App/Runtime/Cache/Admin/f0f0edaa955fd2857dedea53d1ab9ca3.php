...
<head>
    ...
    <link rel="stylesheet" href="/MyBlog/Public/Admin/login/supersized.css">
	<script type="text/javascript">
        var url='/MyBlog/Public';       
    </script>
    <!--[if lt IE 8]>
...
<body class="signin" style="font-size: 14px;">
    ...
    <script src="/MyBlog/Public/Admin/login/jquery-1.8.2.min.js" ></script>
    <script src="/MyBlog/Public/Admin/login/supersized.3.2.7.min.js" ></script>
    <script src="/MyBlog/Public/Admin/login/supersized-init.js" ></script>      
    <script src="/MyBlog/Public/Admin/js/jquery.min.js?v=2.1.4"></script>
    <script src="/MyBlog/Public/Admin/js/bootstrap.min.js?v=3.3.5"></script>
