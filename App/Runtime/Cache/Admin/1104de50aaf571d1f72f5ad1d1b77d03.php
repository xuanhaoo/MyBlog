					...
					<div class="ibox-content">
						...
						<input type="hidden" name="id" value="<?php echo ($detail["id"]); ?>" />
							<div class="form-group">
								...
								<div class="col-sm-6">
									<input type="text" name="a_title" id="a_title" value="<?php echo ($detail["title"]); ?>" placeholder="输入文章标题" class="form-control">
								</div>
							</div>
							...
							<div class="form-group">
				                ...
				                <div class="col-sm-6">                   				                    
                                    <select name="cate_id" class="form-control m-b chosen-select">
			                            <?php if(is_array($cate_list)): foreach($cate_list as $key=>$vo): ?><option value="<?php echo ($vo["cate_id"]); ?>" <?php if(($vo["cate_id"]) == $detail["cate_id"]): ?>selected="selected"<?php endif; ?>><?php echo ($vo["cate_name"]); ?></option><?php endforeach; endif; ?>
			                    	</select>                                    
				                </div>
				            </div>
				            <div class="hr-line-dashed"></div>
							...
							<div class="form-group">
								...
								<div class="col-sm-6">
									<textarea type="text" rows="5" name="a_remark" id="a_remark" placeholder="输入文章描述" class="form-control"><?php echo ($detail["remark"]); ?></textarea>
								</div>
							</div>
							<div class="hr-line-dashed"></div>
							<div class="form-group">
								...
								<div class="col-sm-6">
									...
									<div style="height: 110px; float: left;">
										<img id="upload_img" src="/MyBlog/Uploads/<?php echo ($detail["photo"]); ?>" onerror="this.src='/MyBlog/Public/Admin/img/no_img.jpg'" style="height: 100px" />
									</div>
								</div>
							</div>														
							<div class="hr-line-dashed"></div>
							<div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <script type="text/plain" id="editor" name="a_content" style="width:90%;height:300px;"><?php echo (stripslashes($detail["content"])); ?></script>
                                </div>
                            </div>
							<div class="hr-line-dashed"></div>
							<div class="form-group">
								...
								<div class="col-sm-6">
									<div class="radio i-checks">
										<?php if($detail['or_top'] == 1 ): ?><input type="radio" name='a_top' value="1" checked="checked" />是&nbsp;&nbsp;
										<?php else: ?>
	                        				<input type="radio" name='a_top' value="0" checked/>否<?php endif; ?>
							...
							<div class="form-group">
								...
								<div class="col-sm-6">
									<div class="radio i-checks">
										<?php if($detail['from'] == 1 ): ?><input type="radio" name='a_from' value="1" checked="checked" />原创&nbsp;&nbsp;
										<?php else: ?>
		                        			<input type="radio" name='a_from' value="0" checked/>转载<?php endif; ?>
							...
							<div class="form-group">
								...
								<div class="col-sm-6">
									<input type="text" name="a_views" value="<?php echo ($detail["click"]); ?>" id="views" value="1" class="form-control">
								</div>
							</div>
							<div class="hr-line-dashed"></div>
							<div class="form-group">
								...
								<div class="col-sm-6">
									<input type="text" name="a_writer" value="<?php echo ($detail["author"]); ?>" id="writer" class="form-control" readonly="true">
								</div>
							</div>
							<div class="hr-line-dashed"></div>
							<div class="form-group">
...
<script>
	...
	<script type="text/javascript">
		...
		$("#photo_file").uploadify({
			...
			'uploader': '<?php echo U("Upload/upload_article");?>',
