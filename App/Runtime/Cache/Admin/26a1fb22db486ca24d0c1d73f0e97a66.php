			...
			<div class="col-sm-12">
				<div class="ibox float-e-margins">
					...
					<div class="ibox-content">
						<form class="form-horizontal" method="post" action="<?php echo U('editMoodHandle');?>" name="basic_validate" id="signupForm"> 	<input type="hidden" name="id" value="<?php echo ($detail["id"]); ?>" />
							<div class="hr-line-dashed"></div>
							<div class="form-group">
								<label class="col-sm-2 control-label">文章封面 </label>
								<div class="col-sm-6">
									<div style="width: 200px; height: 110px; float: left;">
										<input type="hidden" name="photo" value="<?php echo ($detail["image"]); ?>" id="data_photo" />
										<input id="photo_file" name="photo_file" type="file" multiple="true" value="" />
									</div>
									<div style="width: 200px; height: 90px; float: left;">
										<img id="upload_img" class="" src="/MyBlog/Uploads/<?php echo ((isset($detail["image"]) && ($detail["image"] !== ""))?($detail["image"]):'touxiang_default.gif'); ?>" style="height: 100px" />
									</div>
								</div>
								</div>
							...
							<div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <script type="text/plain" id="editor" name="a_content" style="width:90%;height:300px;"><?php echo (stripslashes(htmlspecialchars_decode($detail["content"]))); ?></script>
                                </div>
                            </div>
							<div class="hr-line-dashed"></div>
							<div class="hr-line-dashed"></div>
							<div class="form-group">
								...
								<div class="col-sm-6">
									<input type="text" name="a_views" id="a_views" value="<?php echo ($detail["click"]); ?>" class="form-control">
								</div>
							</div>
							<div class="hr-line-dashed"></div>
							<div class="form-group">
	...
	<script type="text/javascript">
		...
		$(function() {
		 ...
		 $("#photo_file").uploadify({
			...
			'uploader': '<?php echo U("Upload/upload_mood");?>',
