...
<meta name="viewport" content="width=device-width, initial-scale=1.0" />
	...
	<link href="/MyBlog/Public/Admin/css/plugins/switchery/switchery.css" rel="stylesheet"><!--IOS开关样式-->	    	
			...
			<div class="col-sm-12">
				<div class="ibox float-e-margins">
					...
					<div class="ibox-content">
						<form class="form-horizontal" method="post" action="<?php echo U('Links/edit');?>" name="signupForm" id="signupForm">	
							...
							<div class="form-group">
								...
								<div class="col-sm-6">
									<div class="radio">
										<?php if($detail['status'] == 1 ): ?><input type="checkbox" name='status' value="1" class="js-switch" checked />
	                        			<?php else: ?>
	                        				<input type="checkbox" name='status' value="1" class="js-switch" /><?php endif; ?>
	                        		</div>
								</div>
							</div>
                            <div class="hr-line-dashed"></div>
							<div class="form-group">
								...
								<div class="col-sm-6">
									<input type="text" name="remark" id="orderby" value="<?php echo ($detail["remark"]); ?>" class="form-control">
								</div>
							</div>
							<div class="hr-line-dashed"></div>
							<div class="form-group">
								<div class="col-sm-4 col-sm-offset-2">
									...
									<a class="btn btn-danger" href="<?php echo U('Links/index');?>">取消</a>
								</div>
							</div>
						</form>
					</div>
...
<script>
	...
	<script src="/MyBlog/Public/Admin/js/plugins/switchery/switchery.js"></script><!--IOS开关样式-->	 
	...
	<script src="/MyBlog/Public/Admin/js/jquery.form.js"></script>
	  <script>
