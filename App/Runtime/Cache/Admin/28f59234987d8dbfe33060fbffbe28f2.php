						...
						<ul class="list-group">
							<li class="list-group-item">
								<p class="text-success"><a href="<?php echo U('Index/index');?>" title="返回首页" class="tip-bottom"><i class="fa fa-home"></i> 首页</a> /
									...
									<a href="<?php echo U('System/userlist');?>" class="tip-bottom">用户管理</a> /
									<a href="#" class="tip-bottom">添加用户</a>
								</p>
							</li>
						</ul>
					</div>
			...
			<div class="col-sm-12">
				<div class="ibox float-e-margins">
					...
					<div class="ibox-content">
						<form class="form-horizontal" method="post" action="<?php echo U('System/addUser');?>" name="basic_validate" id="signupForm">
							<div class="form-group">
								<label class="col-sm-2 control-label">用户名</label>
								<div class="col-sm-6">
									<input type="text" name="username" id="user" placeholder="输入用户名" class="form-control">
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-sm-6">
									<input type="password" id="password" name="password" placeholder="输入密码" class="form-control">
								</div>
							</div>
							<div class="hr-line-dashed"></div>
							<div class="form-group">
								...
								<div class="col-sm-6">
									<input type="text" id="username" name="nickname" placeholder="输入显示名称" class="form-control">
								</div>
							</div>
							<div class="form-group">
								...
								<div class="col-sm-6">
									<div style="width: 200px; height: 90px; float: left;">
										<input type="hidden" name="head_img" value="" id="data_photo" />
										<input id="photo_file" name="photo_file" type="file" multiple="true" value="" />
									</div>
									<div style="width: 200px; height: 90px; float: left;">
										<img id="upload_img" class="img-circle" src="/MyBlog/Uploads/<?php echo ((isset($detail["userimg"]) && ($detail["userimg"] !== ""))?($detail["userimg"]):'touxiang_default.gif'); ?>" style="width: 80px;height: 80px" />
									</div>
								</div>
							</div>
							<div class="hr-line-dashed"></div>
							<div class="form-group">
				                ...
				                <div class="col-sm-6">                   
				                    <select name = "role" class="form-control m-b chosen-select">
				                      <?php if(is_array($role_list)): foreach($role_list as $key=>$var): ?><option value="<?php echo ($var["id"]); ?>"><?php echo ($var["name"]); ?></option><?php endforeach; endif; ?>                  
				                    </select>
				                </div>
				            </div>
							<div class="hr-line-dashed"></div>
							<div class="form-group">
								...
								<div class="col-sm-6">
									<input type="text" name="remark" id="note" placeholder="输入备注信息" class="form-control">
								</div>
							</div>
							<div class="hr-line-dashed"></div>
							<div class="form-group">
								...
								<div class="radio i-checks">
										<label>
											<input type="radio" checked="checked" value="1" name="status"> <i></i> 正常</label>
											<label>
											<input type="radio" value="0" name="status"> <i></i> 停用</label>
									</div>																	
								</div>
							</div>
							<div class="hr-line-dashed"></div>
