...
$(document).ready(function(){
	$("#loginout").click(function(){
		...
		<br />
		<a href="<?php echo U('Article/addtype');?>" class="btn btn-primary">添加分类</a>
		<br />
		<br />
		<div class="row">
			<div class="col-sm-12">
				<div class="ibox float-e-margins">
					...
					<div class="ibox-content">
						<table class="table table-bordered">
							...
							<tbody>
								<?php if(is_array($cate_list)): foreach($cate_list as $key=>$vo): ?><tr class="long-td">
			                            <td><?php echo ($vo["cate_id"]); ?></td>
			                            <td><?php echo ($vo["cate_name"]); ?></td>
			                            <td><?php echo ($vo["order"]); ?></td>
			                            <td>											 
											<a href="<?php echo U('Article/edittype',array('cate_id'=>$vo['cate_id']));?>" class="btn btn-primary btn-mini">
												<i class="fa fa-pencil"></i> 编辑</a>&nbsp;&nbsp;
											<a href="javascript:;" onclick="return deltype(<?php echo ($vo["cate_id"]); ?>,<?php echo I('p',1);?>);" class="btn btn-danger">
		...
		function deltype(cate_id,p){
			...
			layer.close(index);
			window.location.href="/MyBlog/Admin/Article/deltype/cate_id/"+cate_id+"/p/"+p+"";
			});
		}
		</script>
