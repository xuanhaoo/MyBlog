			...
			<div class="col-sm-12">
				<div class="ibox float-e-margins">
					...
					<div class="ibox-content">
						<form action="<?php echo U('edittypeHandle');?>" method="post" class="form-horizontal" id="signupForm">
						<input type="hidden" name="cate_id" value="<?php echo ($detail["cate_id"]); ?>" />
							...
							<div class="form-group">
								...
								<div class="col-sm-6">
									<input type="text" name="order" value="<?php echo ($detail["order"]); ?>" placeholder="输入排序"  class="form-control">
								</div>
							</div>
							<div class="hr-line-dashed"></div>
							<div class="form-group">
