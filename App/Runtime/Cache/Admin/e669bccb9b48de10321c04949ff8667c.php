			...
			<div class="col-sm-12">
				<div class="ibox float-e-margins">
					...
					<div class="ibox-content">
						<form class="form-horizontal" method="post" action="<?php echo U('addHandle');?>" name="basic_validate" id="signupForm">
							<div class="form-group">
				            ...
				            <div class="hr-line-dashed"></div>
							<div class="form-group">
								<label class="col-sm-2 control-label">描述关键字</label>
								<div class="col-sm-6">
									<input type="text" name="a_remark" id="a_keyword" placeholder="输入文章关键字" class="form-control">
								</div>
							</div>
							<div class="hr-line-dashed"></div>
							<div class="hr-line-dashed"></div>
							...
							<div class="form-group">
								...
								<div class="col-sm-6">
									<div class="radio i-checks">
										<input type="radio" name='a_top' value="1"  />是&nbsp;&nbsp;
	                        			<input type="radio" name='a_top' value="0" checked="checked"/>否
	                        		</div>
								</div>
							</div>
							<div class="hr-line-dashed"></div>
							<div class="form-group">
								...
								<div class="col-sm-6">
									<div class="radio i-checks">
										<input type="radio" name='a_from' value="1" checked="checked" />原创&nbsp;&nbsp;
	                        			<input type="radio" name='a_from' value="0" />转载
	                        		</div>
								</div>
							</div>
							<div class="hr-line-dashed"></div>
