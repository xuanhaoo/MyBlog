...
$(document).ready(function(){
	$("#loginout").click(function(){
						...
						<ul class="list-group">
							<li class="list-group-item">
								<p class="text-success"><a href="<?php echo U('Index/index');?>" title="返回首页" class="tip-bottom"><i class="fa fa-home"></i> 首页</a> /
									<a href="#" class="tip-bottom"> 系统管理</a> / <a href="<?php echo U('System/role');?>" class="tip-bottom">角色管理</a></p>
							</li>
						</ul>
					</div>
				</div>
		...
		<a href="<?php echo U('System/addrole');?>" class="btn btn-primary">添加角色</a>
		<br />
		<br />
		<div class="row">
			<div class="col-sm-12">
						...
						<table class="table table-bordered">
							...
							<tbody>
								<?php if(is_array($list)): $val = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($val % 2 );++$val;?><tr class="long-td">
										...
										<td>
											<a href="<?php echo U('setting_access',array('id'=>$vo['id']));?>" class="btn btn-success">权限设置</a>&nbsp;&nbsp;
											<a href="<?php echo U('editRole',array('id'=>$vo['id']));?>" class="btn btn-primary"><i class="fa fa-pencil"></i> 编辑</a>&nbsp;&nbsp;
											<a onClick="return confirm('是否删除此条记录')" href="<?php echo U('delRole',array('id'=>$vo['id']));?>" class="btn btn-danger demo1">
